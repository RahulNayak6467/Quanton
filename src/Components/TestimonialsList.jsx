function TestimonialsList({ avatar, name, review, role }) {
  return (
    <div className="flex-col gap-4 max-w-120 h-fit p-6 border-2 rounded-2xl cursor-pointer border-bg-card hover:border-accent   hover:scale-105 transition-all hover:shadow-[0_0px_10px_rgba(16,185,129,0.8)] hover:paused">
