...
//               <div className="flex-1 h-[1px] bg-border" />
//             </div>
//             <button className="w-full px-4 py-3 rounded-2xl bg-bg-card text-text-primary fontfont-extrabold flex items-center text-center mt-4 gap-3 border border-zinc-400 justify-center cursor-pointer hover:opacity-80">
//               <img
...
//             </button>
//             <button className="w-full px-4 py-3 rounded-2xl bg-bg-card text-text-primary fontfont-extrabold flex items-center text-center mt-4 gap-3 border border-zinc-400 justify-center cursor-pointer hover:opacity-85">
//               <img
      ...
      <div className="rounded-2xl flex-col border-bg-card border-2 w-[80%] p-6">
        ...
        <div className="flex-col">
          ...
          <div>
            ...
            <button className="w-full px-4 py-3 rounded-2xl bg-bg-card text-text-primary flex items-center text-center mt-4 gap-3 border border-zinc-400 justify-center cursor-pointer hover:opacity-80">
              <img
                src="https://www.svgrepo.com/show/475656/google-color.svg"
                alt="Google"
                className="h-6 w-6"
            ...
            <button className="w-full px-4 py-3 rounded-2xl bg-bg-card text-text-primary flex items-center text-center mt-4 gap-3 border border-zinc-400 justify-center cursor-pointer hover:opacity-85">
              <img
                src="https://www.svgrepo.com/show/512317/github-142.svg"
                alt="Github"
                className="h-6 w-6 invert"
